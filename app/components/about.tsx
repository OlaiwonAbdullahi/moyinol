      ...
      <div className="w-11/12 flex md:flex-row flex-col mx-auto gap-6">
        <div className="space-y-6 md:w-1/2 w-full">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            institutions in building strong AML frameworks and maintaining
            ongoing compliance with both local and international regulatory
            requirements. With a team of certified compliance professionals,
            project managers and legal experts, we bring a practical approach to
            helping clients detect, prevent, and respond to financial crime
            risks. Moyinol Consulting combines deep regulatory expertise with
